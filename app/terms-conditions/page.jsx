    ...
    <>
      <Container className="py-12">
        ...
        <div className="prose prose-lg max-w-4xl text-gray-200 space-y-6">
          <p>
            Welcome to <strong>Hassan Sanitary Store</strong>. By accessing our website or making a
            purchase, you agree to be bound by these Terms & Conditions. Please read them carefully.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">1. General</h2>
          <p>
            Hassan Sanitary Store operates this website to provide plumbing products and related
            information to customers in Pakistan, especially Khyber Pakhtunkhwa (KPK). We reserve
          ...
          <p>
            To place an order, you may need to create an account. You are responsible for
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              We reserve the right to correct any pricing errors and cancel orders if necessary.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              We accept payment via bank transfer, credit/debit card, or cash on delivery (COD)
              where available.
            </li>
            <li>For COD orders, full payment is required upon delivery.</li>
            <li>
              Once an order is placed, you will receive a confirmation email. We may contact you for
              verification.
            </li>
            <li>
              We reserve the right to refuse or cancel any order for reasons including fraud,
              inaccurate information, or stock unavailability.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              We deliver across KPK and other regions of Pakistan. Delivery times are estimates and
              not guaranteed.
            </li>
            <li>Shipping costs are calculated at checkout based on location and order weight.</li>
            <li>
              Risk of loss passes to you upon delivery. Please inspect products immediately and
              report any damage.
            </li>
            <li>
              Delays may occur due to weather, strikes, or other unforeseen circumstances. We are
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              We accept returns within 7 days of delivery if the product is defective, damaged, or
              incorrect.
            </li>
            <li>
              Items must be unused and in original packaging. Return shipping costs are borne by the
              customer unless the error is ours.
            </li>
            <li>
              Refunds will be processed within 5-7 business days after inspection and approval.
            </li>
          ...
          <p>
            Product warranties vary by brand and product. Please refer to the product description or
            contact us for warranty details. Our liability is limited to repair, replacement, or
            refund of the product price.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">8. Limitation of Liability</h2>
          <p>
            To the maximum extent permitted by law, Hassan Sanitary Store shall not be liable for
            any indirect, incidental, or consequential damages arising from the use of our products
            or website. Our total liability shall not exceed the amount paid for the product.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">9. Intellectual Property</h2>
          <p>
            All content on this site (text, images, logos, etc.) is the property of Hassan Sanitary
            Store or its licensors and is protected by copyright laws. You may not reproduce,
          ...
          <p>
            ...
            exclusive jurisdiction of the courts in Peshawar, KPK.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              Email:{' '}
              <a href="mailto:support@kpkplumbing.com" className="text-blue-600 hover:underline">
                support@kpkplumbing.com
              </a>
            </li>
            <li>
              WhatsApp:{' '}
