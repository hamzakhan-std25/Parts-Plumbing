    ...
    <>
      <Container className="py-12">
        ...
        <div className="prose prose-lg max-w-4xl text-gray-200 space-y-6">
          <p>
            At <strong>Hassan Sanitary Store</strong>, we value your privacy and
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              Create an account or place an order (name, email, phone, shipping
              address).
            </li>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              To communicate with you about your orders, inquiries, or
              promotions.
            </li>
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              ...
              companies, and IT support (bound by confidentiality).
            </li>
            <li>
          ...
          <p>
            ...
            your browser settings. By continuing to use our site, you consent to
            our use of cookies.
          </p>
          ...
          <p>
            ...
            <a
              href="mailto:privacy@kpkplumbing.com"
          ...
          <p>
            Our site is not intended for individuals under 18. We do not
