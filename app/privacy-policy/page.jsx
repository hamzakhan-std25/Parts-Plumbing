    ...
    <>
      <Container className="py-12">
        ...
        <div className="prose prose-lg max-w-4xl text-gray-200 space-y-6">
          <p>
            At <strong>Hassan Sanitary Store</strong>, we value your privacy and are committed to
            protecting your personal data. This privacy policy explains how we collect, use,
            disclose, and safeguard your information when you visit our website and purchase our
          ...
          <ul className="list-disc pl-6 space-y-1">
            <li>
              <strong>Service providers:</strong> Payment processors, delivery companies, and IT
              support (bound by confidentiality).
            </li>
            <li>
          ...
          <p>
            ...
            personalize content. You can control cookies through your browser settings. By
          ...
          <p>
            ...
            <a href="mailto:privacy@kpkplumbing.com" className="text-blue-600 hover:underline">
              privacy@kpkplumbing.com
            </a>
            .
          </p>
          ...
          <p>
            ...
            privacy practices and encourage you to read their policies.
          </p>

          <h2 className="text-2xl font-semibold mt-8 mb-4">8. Children’s Privacy</h2>
          <p>
            Our site is not intended for individuals under 18. We do not knowingly collect data from
            children.
          </p>
